...
// 댓글 전체 목록 조회
router.get('/comment/:articleId', async (req: Request, res: Response) => {
...
// 댓글 생성기능
router.post('/comments', authMiddlleware, async (req: Request, res: Response) => {
...
// 댓글 수정기능
router.patch('/comment/:commentId', authMiddlleware, async (req: Request, res: Response) => {
...
// 삭제기능
router.delete('/comment/:commentId', authMiddlleware, async (req: Request, res: Response) => {
    const { commentId } = req.params;
    const nickname = res.locals.user[0].nickname;
